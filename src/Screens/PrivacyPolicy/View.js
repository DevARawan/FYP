  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.paragraph}>
        ...
        application ("App"). Your privacy is important to us. This Privacy
      ...
      <Text style={styles.paragraph}>
        ...
        App. The information we may collect includes:
      </Text>

      <Text style={styles.listItem}>
        - Personal Information: We may collect personal information that you
        voluntarily provide to us when you register for the App, such as your
        name, email address, and other contact information.
      </Text>
      <Text style={styles.listItem}>
        - Financial Information: We may collect information related to your
      ...
      <Text style={styles.listItem}>
        - Analyze usage of the App and improve our services;
      </Text>
      <Text style={styles.listItem}>
      ...
      <Text style={styles.paragraph}>
        ...
        with personal information, please contact us so that we can delete the
        information.
      </Text>
